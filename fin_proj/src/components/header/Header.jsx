      ...
      <div className="header-wrapper _container">
        <div className="header-logo">
          ...
          <div className="header-button header-button__logo">
            <ButtonFunc class="header-buttonlogo-style">Sign Up</ButtonFunc>

            <div className='header__logo-theame' variant="secondary" onClick={handleLightThemeClick}>
        ...
        <div className="header-button">
          ...
          <div className='header__theame' variant="secondary" onClick={handleLightThemeClick}>
            {theme === 'light' && (
              <div className="button-theme-icon">
                <img src="/src/icon/sun.png" alt="" />
              </div>
